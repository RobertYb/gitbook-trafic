...
<body>
    <div class="ceng">
        <button type="button" class="btn btn-primary" id="add_layer">添加摄像头图层(多图标,非聚合,非动态)</button>
        <button type="button" class="btn btn-primary" id="remove_layer">删除摄像头图层</button>
    </div>
    <div id="map"></div>
