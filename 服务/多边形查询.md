...
> 通过关键字，行政编码，经营产业类型等查询，并指定形状


![多边形查询](../images/多边形查询.png)
    ...
    `;
        ...
        `;
            ...
            function doSearch(type) {
                ...
                switch (type) {
                    case 'triangle':
                        kmap.queryTriangleSpace(params);
                        break;
                    case 'rectangle':
                        kmap.queryRectangleSpace(params);
                        break;
                    case 'circular':
                        kmap.queryCircularSpace(params);
                        break;
                    case 'polygon':
                        kmap.queryPolygonSpace(params);
                        break;
                    default:
                        break;
                }
